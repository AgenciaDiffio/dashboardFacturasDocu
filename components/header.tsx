      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-1">
            <NavButton label="Resumen" onClick={() => onTabChange("overview")} active={activeTab === "overview"} />
            <NavButton label="Ingresos" onClick={() => onTabChange("ingresos")} active={activeTab === "ingresos"} />
            <NavButton label="Egresos" onClick={() => onTabChange("egresos")} active={activeTab === "egresos"} />
          </nav>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="bg-white border-gray-200">
              <DropdownMenuItem onClick={onLogout} className="text-gray-600 hover:text-gray-900">
                Cerrar Sesión
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
